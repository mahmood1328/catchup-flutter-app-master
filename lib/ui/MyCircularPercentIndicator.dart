...
/// see [MyCircularProgressIndicator].
///
/// See also:
///
...
/// See also:
///
///  * [MyCircularProgressIndicator], which shows progress along a circular arc.
///  * [RefreshIndicator], which automatically displays a [MyCircularProgressIndicator]
...
class _CircularProgressIndicatorPainter extends CustomPainter {
  ...
  @override
  void paint(Canvas canvas, Size size) {
    final double mArcStart = this.reversed ? -this.arcStart : this.arcStart;
    ...
    if (backgroundColor != null) {
      ...
      canvas.drawArc(Offset.zero & size, 0, _sweep - 0, false, backgroundPaint);
    }

    paint.strokeCap = StrokeCap.round;

    canvas.drawArc(Offset.zero & size, mArcStart, arcSweep, false, paint);
  }
...
class MyCircularProgressIndicator extends ProgressIndicator {
...
class _CircularProgressIndicatorState extends State<MyCircularProgressIndicator>
    with SingleTickerProviderStateMixin {
  AnimationController _controller;
...
///  * [RefreshIndicator], which automatically displays a [MyCircularProgressIndicator]
///    when the underlying vertical scrollable is overscrolled.
class RefreshProgressIndicator extends MyCircularProgressIndicator {
